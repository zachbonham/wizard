...
export default class Preloader extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        this.load.image("combat-tiles", "./tiles/dungeon-03.png");
        ...
        this.load.tilemapTiledJSON("combat", "./tiles/dungeon-03.json");

        this.load.atlas("knight1", "./characters/knight.png", "./characters/knight_atlas.json");
        //this.load.atlas("knight1", "./characters/knight-green.png", "./characters/knight_atlas.json");
